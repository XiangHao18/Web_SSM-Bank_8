...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr/><tr>
        <th>取出金额：</th><td><input type="number" name="balance" id="balance"></td>
    <tr/><tr>
    ...
    <tr/><tr>
        <th></th><td><button type="submit" onclick="addSubmit()">提交取出</button></td>
    </tr>
</table>
<script type="text/javascript">
    function addSubmit() {
        ...
        if (Tpassword!=params.password){
            ...
            $.ajax({
                type: 'post',
                url: '<%=basePath%>updateRemBankcard.action',
                data: params,
                dataType: "json",
